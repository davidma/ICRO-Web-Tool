     ...
     if ($theSentry->hasPermission(2) || $_SESSION['user_id'] == $_GET['user_id'] || $_SESSION['user_id'] == $_POST['user_id'])
     {
         ...
         else if (isset($_GET['user_id']))
         {
             ...
             else
             {
                 ...
                 echo "<input type=\"text\" name=\"fname\" value='".$res[0]['first_name']."' maxlength=\"50\">";
                 echo "</td></tr>";
                 echo "<tr><td>Last Name*:</td><td>";
                 echo "<input type=\"text\" name=\"lname\" value='".$res[0]['last_name']."' maxlength=\"50\">";
                 echo "</td></tr>";
                 echo "<tr><td>E-Mail*:</td><td>";
                 echo "<input type=\"text\" name=\"email\" value='".$res[0]['email']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>Address Line 1:*</td><td>";
                 echo "<input type=\"text\" name=\"location1\" value='".$res[0]['address_line1']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>Address Line 2:</td><td>";
                 echo "<input type=\"text\" name=\"location2\" value='".$res[0]['address_line2']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>Town*:</td><td>";
                 echo "<input type=\"text\" name=\"locationTown\" value='".$res[0]['town']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>County*:</td><td>";
                 echo "<input type=\"text\" name=\"county\" value='".$res[0]['county']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>Postcode:</td><td>";
                 echo "<input type=\"text\" name=\"postcode\" value='".$res[0]['postcode']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>Mobile Contact Number:*</td><td>";
                 echo "<input type=\"text\" name=\"mobile\" value='".$res[0]['mobile_phone']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>Home Contact Number:</td><td>";
                 echo "<input type=\"text\" name=\"home\" value='".$res[0]['home_phone']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>Work Contact Number:</td><td>";
                 echo "<input type=\"text\" name=\"work\" value='".$res[0]['work_phone']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>Other Contact Number:</td><td>";
                 echo "<input type=\"text\" name=\"other\" value='".$res[0]['other_phone']."' maxlength=\"100\">";
                 echo "</td></tr>";
                 echo "<tr><td>FFS Insurance No:</td><td>";
                 echo "<input type=\"text\" name=\"ffsno\" value='".$res[0]['ffs_num']."' maxlength=\"100\">";
                 echo "</td></tr>";
